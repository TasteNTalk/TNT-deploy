...
const Tiffin = () => {
  ...
  return (
    ...
    <div>
          <div>
      <div className="bg-[#002140] min-h-screen font-sans">
            ...
            <div className="container mx-auto px-4 h-full flex flex-col justify-center">
              <div className="text-white w-full">
                ...
                <p className="text-base md:text-lg mb-4">
                  Connect with home chefs and tiffin providers near you for daily fresh, homemade meals
                </p>
                ...
                <div className="flex flex-col md:flex-row md:items-center gap-4">
                  ...
                  <div className="flex items-center gap-4 text-white">
                    <a href="#" className="relative hover:text-orange-300 transition">
        ...
        <div className="container mx-auto px-4 py-8">
          <div className="bg-gradient-to-r from-black/40 via-black/25 to-transparent rounded-xl shadow-md p-6 mb-8">
            <div className="flex flex-wrap gap-4 mb-6">
              {['all', 'veg', 'north', 'south', 'healthy'].map((tab) => (
                <button
                  key={tab}
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              {['Price Range', 'Delivery Time', 'Dietary Preferences'].map((label, i) => (
                <div key={i} className="relative">
                  <select className="w-full appearance-none bg-white text-[#002140] py-3 px-4 rounded-[25px] 
          ...
          <h2 className="text-2xl font-bold text-white mb-6">Featured Tiffin Providers</h2>
    ...
    <div className="bg-gradient-to-r from-black/40 via-black/25 to-transparent rounded-xl shadow-md overflow-hidden hover:shadow-lg transition duration-300">
      <div className="relative">
        <img src="/api/placeholder/400/200" alt="South Spice Kitchen" className="w-full h-48 object-cover" />
        ...
        <div className="absolute bottom-3 right-3 bg-white/90 backdrop-blur-sm text-sm font-medium px-3 py-1 rounded-full">
          <i className="fas fa-clock text-blue-600 mr-1"></i> 25 min delivery
        </div>
      </div>
      <div className="p-5">
        <div className="flex justify-between items-start mb-3">
          <div>
            <h3 className="text-xl font-bold text-white">South Spice Kitchen</h3>
            <p className="text-gray-400 text-sm">South Indian, Traditional</p>
          </div>
        ...
        <p className="text-gray-400 text-sm mb-4">
          Authentic South Indian meals including idli, dosa, sambar rice, and traditional curries.
        </p>
        <div className="flex flex-wrap gap-2 mb-4">
          <span className="bg-gray-100 text-gray-800 text-xs px-2 py-1 rounded-full">Pure Veg</span>
          <span className="bg-gray-100 text-gray-800 text-xs px-2 py-1 rounded-full">Organic</span>
          <span className="bg-gray-100 text-gray-800 text-xs px-2 py-1 rounded-full">Eco-friendly Packaging</span>
        </div>
        <div className="flex justify-between items-center">
          ...
          <button
            className="bg-white text-[#ff4d4d] border-none py-2 px-5 rounded-full font-semibold cursor-pointer transition-all duration-300 shadow-md hover:bg-[#ff4d4d] hover:text-white hover:-translate-y-[2px]"
          >
            View Plans
          </button>
        </div>
    ...
    <div className="bg-gradient-to-r from-black/40 via-black/25 to-transparent rounded-xl shadow-md overflow-hidden hover:shadow-lg transition duration-300">
      <div className="relative">
        <img src="/api/placeholder/400/200" alt="Fit Food Kitchen" className="w-full h-48 object-cover" />
        <div className="absolute top-3 left-3 bg-green-600 text-white text-xs font-bold px-3 py-1 rounded-full">
          HEALTHY
        </div>
        <div className="absolute bottom-3 right-3 bg-white/90 backdrop-blur-sm text-sm font-medium px-3 py-1 rounded-full">
          <i className="fas fa-clock text-blue-600 mr-1"></i> 35 min delivery
        </div>
      </div>
      <div className="p-5">
        <div className="flex justify-between items-start mb-3">
          <div>
            <h3 className="text-xl font-bold text-white">Fit Food Kitchen</h3>
            <p className="text-gray-400 text-sm">Health Food, Calorie Counted</p>
          </div>
          <div className="flex items-center bg-green-50 px-2 py-1 rounded-lg">
        ...
        <p className="text-gray-400 text-sm mb-4">
          Nutrition-focused meals with calorie counting. Perfect for fitness
          enthusiasts and health-conscious individuals.
        </p>
        <div className="flex flex-wrap gap-2 mb-4">
          <span className="bg-gray-100 text-gray-800 text-xs px-2 py-1 rounded-full">Protein-Rich</span>
          <span className="bg-gray-100 text-gray-800 text-xs px-2 py-1 rounded-full">Gluten-Free</span>
          <span className="bg-gray-100 text-gray-800 text-xs px-2 py-1 rounded-full">Keto Options</span>
        </div>
        <div className="flex justify-between items-center">
          <div>
    ...
    <div className="mb-16">
      <div className="bg-gradient-to-r from-black/40 via-black/25 to-transparent rounded-xl p-6 md:p-8 mb-8">
        <div className="flex flex-col md:flex-row items-center justify-between">
          <div className="mb-6 md:mb-0 md:mr-8">
            <h2 className="text-2xl md:text-3xl font-bold text-white mb-3">How Our Tiffin Marketplace Works</h2>
            <p className="text-gray-400 max-w-2xl">
              Taste'n Talk connects you with the best local tiffin providers. We don't make the food - we bring the makers to you!
            </p>
          </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
        {[
          ...
          <div key={idx} className={`bg-gradient-to-r from-black/40 via-black/25 to-transparent rounded-xl shadow-md p-6 text-center text-white transform transition-transform duration-300 hover:scale-105 hover:shadow-lg ${step.shadow}`}>
      ...
      <div id="subscription-plans" className="bg-white rounded-xl shadow-lg overflow-hidden mb-12">
        <div className="bg-gradient-to-r from-[#0e1e2c] via-[#183248] to-[#0e1e2c] py-8 px-6 md:px-10 outline-none border-none">
          <h2 className="text-2xl md:text-3xl font-bold text-white mb-2">Subscription Plans</h2>
          <p className="text-blue-100">Subscribe to your favorite tiffin provider and save more</p>
        </div>
            ...
            {[
              {
                ...
                exclusions: ["Priority delivery", "Weekend special dishes"],
              ...
              <div key={idx} className={`${plan.border} bg-[#e2e4d6] rounded-xl overflow-hidden hover:border-blue-400 transition-all duration-300 hover:shadow-md ${plan.popular ? 'hover:shadow-xl' : ''}`}>
                {plan.popular && (
                  <div className="absolute top-0 right-0 bg-blue-600 text-white px-4 py-1 text-sm font-bold">POPULAR</div>
                )}
                <div className="bg-[#e2e4d6] p-6">
                  <h3 className="text-xl font-bold text-[#002140]">{plan.title}</h3>
                ...
                <div className="p-6">
                  <ul className="space-y-3 mb-6">
                    ...
                    {plan.exclusions && plan.exclusions.map((exc, i) => (
    ...
    <div>
      ...
      <div className="bg-gradient-to-r from-black/40 via-black/25 to-transparent rounded-xl p-6 md:p-8 mb-12">
        <div className="flex flex-col md:flex-row items-center text-white">
          <div className="mb-6 md:mb-0 md:mr-8 md:w-1/2">
            <h2 className="text-2xl md:text-3xl font-bold mb-3">Are You a Tiffin Provider?</h2>
            <p className="mb-6">
              Join our platform to reach more customers, manage your subscriptions efficiently, and grow your tiffin business.
            </p>
            <ul className="space-y-3 mb-6">
              <li className="flex items-start">
                <i className="fas fa-check-circle text-green-400 mt-1 mr-2"></i>
                <span>Reach thousands of potential customers in your area</span>
              </li>
              <li className="flex items-start">
                <i className="fas fa-check-circle text-green-400 mt-1 mr-2"></i>
                <span>Dedicated dashboard to manage orders and subscriptions</span>
              </li>
              <li className="flex items-start">
                <i className="fas fa-check-circle text-green-400 mt-1 mr-2"></i>
                <span>Flexible commission structure with weekly payouts</span>
              </li>
              <li className="flex items-start">
                <i className="fas fa-check-circle text-green-400 mt-1 mr-2"></i>
                <span>Marketing support and business growth insights</span>
              </li>
            </ul>
          ...
          <div className="md:w-1/2">
            <img src="/api/placeholder/600/400" alt="Provider" className="w-full rounded-lg shadow-md" />
          </div>
        </div>
      </div>
      ...
      <div className="mb-16">
        <h2 className="text-2xl font-bold text-white mb-8 text-center">What Our Customers Say</h2>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="bg-[#e2e4d6] rounded-xl shadow-md p-6 relative">
            ...
            <div className="pt-4">
              <p className="text-gray-600 italic mb-4">
                "I've been using Taste'n Talk's tiffin service for the past 3 months and it has completely transformed my lunch routine. The meals are fresh, delicious and arrive right on time."
              </p>
              <div className="flex items-center">
                <img src="/api/placeholder/40/40" alt="Customer" className="h-10 w-10 rounded-full mr-3" />
                <div>
          ...
          <div className="bg-[#e2e4d6] rounded-xl shadow-md p-6 relative">
            ...
            <div className="pt-4">
              <p className="text-gray-600 italic mb-4">
                "As a busy professional, finding time to cook healthy meals was always a challenge. The monthly subscription from Fit Food Kitchen has been a game-changer for my health goals."
              </p>
              <div className="flex items-center">
                <img src="/api/placeholder/40/40" alt="Customer" className="h-10 w-10 rounded-full mr-3" />
                <div>
                  <h4 className="font-bold text-gray-800">Rahul Kapoor</h4>
                  <div className="flex text-yellow-400">
                    <i className="fas fa-star"></i>
                    <i className="fas fa-star"></i>
                    <i className="fas fa-star"></i>
    ...
    <div>
        ...
        <div className="space-y-4 max-w-3xl mx-auto">
          {[
            ...
            <div key={index} className="border border-gray-200 rounded-lg overflow-hidden">
              ...
              >
                <span className="font-medium text-[#002140]">{item.question}</span>
                {/* <i
      ...
      <div className="bg-gradient-to-r from-transparent via-black/60 rounded-xl p-6 md:p-8 mb-16">
        <div className="max-w-3xl mx-auto text-center text-white">
          ...
          <p className="mb-6">
            Subscribe to our newsletter to receive updates on new tiffin providers, special offers, and healthy eating tips.
          </p>
    ...
    <footer className="bg-gradient-to-r from-black via-black/60 to-transparent text-white pt-12 pb-6 rounded-lg">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          {/* Taste'nTalk Section */}
          <div>
            <h3 className="text-xl font-bold mb-4">Taste<span className="text-orange-400">'</span>nTalk</h3>
            <p className="text-gray-400 mb-4">
              Connecting food lovers with authentic home-cooked tiffin services across India.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><a href="#" className="text-gray-400 hover:text-white transition">Find Tiffin Services</a></li>
              <li><a href="#" className="text-gray-400 hover:text-white transition">Subscription Plans</a></li>
              <li><a href="#" className="text-gray-400 hover:text-white transition">Become a Provider</a></li>
              <li><a href="#" className="text-gray-400 hover:text-white transition">Offers & Discounts</a></li>
              <li><a href="#" className="text-gray-400 hover:text-white transition">Download App</a></li>
            </ul>
          </div>
        ...
        <div className="text-center text-gray-500 text-sm">
          <p>
            &copy; 2025 <a href="#"><span className="text-orange-400">Taste'n Talk</span></a>. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
