      ...
      <div className="flex justify-center items-center container ml-[250px] -mt-[720px] py-12 px-4 md:px-6 w-auto">
        <div className="flex flex-col h-full w-full max-w-6xl">
          <div className="flex justify-between gap-5 mb-8 flex-wrap md:flex-nowrap">
            <div
              id="recipe-assistant"
              className="feature-card scale-110 bg-gradient-to-r from-black/40 via-black/25 to-transparent shadow-lg shadow-[#081c2e] hover:shadow-xl hover:shadow-[#061524] rounded-lg p-5 flex-1 flex flex-col items-center text-center transform transition-all duration-300 hover:-translate-y-1 bg-opacity-80 cursor-pointer "
            >
            ...
            >
              ...
              <p className="text-sm text-white text-opacity-80">
                Ask any food-related questions
              </p>
            </div>
            <div
              id="shopping-helper"
            ...
            >
              ...
              <p className="text-sm text-white text-opacity-80">
                Meal planning & ingredient suggestions
              </p>
            </div>
          </div>
          ...
          <div className="flex flex-col h-[60vh] border-2 border-[#002140] rounded-2xl shadow-xl bg-gray-50 overflow-hidden">
            ...
            <div className="flex-1 overflow-y-auto p-6 flex flex-col gap-4 bg-gradient-to-br from-gray-50 to-white bg-opacity-75">
              <div className="max-w-3/4 self-start bg-gradient-to-r from-gray-100 to-gray-200 rounded-2xl rounded-bl-sm px-5 py-3 shadow border-l-4 border-[#002140] transform transition duration-200 hover:-translate-y-1">
                <div>
                  👋 Hello chef! I'm Cheffi, your TasteBot assistant. Let me
                  help you discover amazing recipes and cooking tips!
                </div>
                ...
                <div className="flex gap-1 mt-1 pl-2">
                  <div
                    className="w-2 h-2 bg-[#002140] rounded-full animate-bounce opacity-70"
                ...
                <div className="flex flex-wrap gap-3 mt-3">
                  <button className="bg-white px-4 py-2 rounded-full text-sm border border-gray-200 shadow hover:bg-[#002140] hover:text-white transition-all duration-300 hover:scale-105 cursor-pointer">
                    🍳 Find a recipe
                  </button>
                  <button className="bg-white px-4 py-2 rounded-full text-sm border border-gray-200 shadow hover:bg-[#002140] hover:text-white transition-all duration-300 hover:scale-105 cursor-pointer">
                    👨‍🍳 Cooking tips
              ...
              <div className="max-w-3/4 self-start bg-gradient-to-r from-gray-100 to-gray-200 rounded-2xl rounded-bl-sm px-5 py-3 shadow border-l-4 border-[#002140] transform transition duration-200 hover:-translate-y-1">
                <div>
                  I'd be happy to help! Here's a quick and easy pasta recipe:
                </div>
                <div className="mt-3 font-semibold text-[#002140]">
